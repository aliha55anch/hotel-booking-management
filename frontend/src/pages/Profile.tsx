...
import { PencilIcon, MailIcon } from '../components/ui/icons'
...
function resizeImage(dataUrl: string, maxSize: number): Promise<string | null> {
...
function ProfileContent({ token }: { token: string | null }) {
  ...
  const handleFile = async (file: File | undefined) => {
    ...
    const resized = dataUrl ? await resizeImage(dataUrl, MAX_IMAGE_SIZE) : null
