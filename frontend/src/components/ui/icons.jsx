export function HotelIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function WifiIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function PoolIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function UtensilsIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DumbbellIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M6.404 12.768a2 2 0 1 1-2.829 2.829l1.768 1.767a2 2 0 1 1-2.828 2.829l2.828-2.829z" />
    </svg>
  )
}

export function CoffeeIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BathIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M2 12h20" />
      <path d="M7 19v2" />
      <path d="M9 5 7.62 3.62A2 2 0 1 0 4.85 6.4L8.13 9.5" />
      <path d="M2 12v-3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3" />
      <path d="M2 12v6a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1v-6" />
    </svg>
  )
}
...
export function FlameIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ShuttleIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function KitchenIcon({ className = 'h-5 w-5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M4 8V6a2 2 0 0 1 2-2h2.5" />
      <path d="M12 2v4" />
    </svg>
  )
}
