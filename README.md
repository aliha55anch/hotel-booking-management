...
- **Backend:** Node.js, Express 5, Mongoose, jsonwebtoken, bcryptjs, Stripe, Nodemailer
...
> First account created via the public sign-up endpoint becomes the system `owner`.
