...
const toValues = (hotel: Hotel): HotelFormValues => ({
  name: hotel.name || '',
  city: hotel.city || '',
...
export default function HotelForm({ open, hotel, token, onClose, onSaved }: HotelFormProps) {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<HotelFormValues>({ defaultValues: emptyValues })
