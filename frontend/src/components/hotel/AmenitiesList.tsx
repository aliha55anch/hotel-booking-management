...
const iconFor = (amenity: string): ComponentType<IconComponentProps> => {
...
export default function AmenitiesList({ amenities = [], limit }: AmenitiesListProps) {
