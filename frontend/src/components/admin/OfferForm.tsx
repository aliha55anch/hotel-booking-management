...
import type { Offer, Hotel } from '@/types'
...
const toValues = (offer: Offer): OfferFormValues => ({
  title: offer.title || '',
...
export default function OfferForm({ open, offer, token, onClose, onSaved }: OfferFormProps) {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<OfferFormValues>({ defaultValues: emptyValues })
