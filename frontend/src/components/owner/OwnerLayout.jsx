...
function OwnerError({ message, onRetry }) {
  return (
...
function ClerkOwner() {
  ...
  return <OwnerShell token={token} />
}

export default function OwnerLayout() {
  if (CLERK_PUBLISHABLE_KEY) return <ClerkOwner />
  return <OwnerShell token={undefined} />
}
