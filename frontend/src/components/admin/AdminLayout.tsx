...
import { MenuIcon, CloseIcon, GridIcon, HotelIcon, BedIcon, CalendarIcon, UsersIcon, AlertIcon, LogoutIcon, FlameIcon } from '../ui/icons'
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="flex max-w-md flex-col items-center gap-4 rounded-card border border-line bg-surface p-10 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted">You need an admin account to view this area.</p>
        </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="flex w-full max-w-md flex-col items-center gap-4 rounded-card border border-line bg-surface p-10 text-center">
        ...
        <div>
          <h1 className="font-heading text-xl font-semibold text-ink">Couldn't load admin</h1>
...
function AdminShell({ token, handleLogout }: { token: string | null; handleLogout: () => void }) {
